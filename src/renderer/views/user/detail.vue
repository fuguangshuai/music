              ...
              <div class="user-info-content">
                ...
                <div class="user-info-detail">
                  <div class="user-info-name">
                    ...
                    <n-tooltip
                      v-if="isArtist(userDetail.profile)"
                      trigger="hover"
                    >
                      <template #trigger>
...
<script lang="ts" setup>
  ...
  const playList = ref<any[]>([0]);
  const recordList = ref<any[]>([0]);
    ...
    try {
      ...
      try {
        ...
        if (recordRes.data && recordRes.data.allData) {
          recordList.value = recordRes.data.allData.map((item: unknown) => ({
            ...item, ...item.song,
