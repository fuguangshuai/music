<template>
  <div
    v-if="isComponent ? favoriteSongs.length : true"
    class="favorite-page"
  >
    <div
...
<script setup lang="ts">
  ...
  const favoriteSongs = ref<SongResult[]>([0]);
