<template>
  ...
  >
    <n-drawer-content
      :title="t('comp.playlistDrawer.title')"
          ...
          <div class="create-playlist-section">
            ...
            >
              <div class="create-playlist-icon">
                <i
                  class="iconfont"
                  :class="isCreating ? 'ri-close-line' : 'ri-add-line'"
                ></i>
              </div>
            ...
            >
              ...
              <div class="privacy-switch">
                ...
                <n-switch
                  v-model:value="formValue.privacy"
...
<script lang="ts" setup>
  ...
  const fetchUserPlaylists = async () => {
    try {
      ...
      if (res.data?.playlist) {
        playlists.value = res.data.playlist.filter((item: unknown) => item.userId === user.userId);
      }
    } catch (error) {
  ...
  const handleAddToPlaylist = async (playlist: unknown) => {
    ...
    try {
      ...
      message.error(error._message || t('comp.playlistDrawer.addFailed'));
    }
  }
